...
// 1. Overall Trend Icon (Trending line upwards / chart)
...
// 2. Market Structure Icon (Layers / Structure blocks)
export function StructureIcon({ size = 18, className = "" }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
// 3. Support & Resistance Icon (Horizontal levels / Bar Chart)
export function LevelsIcon({ size = 18, className = "" }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
// 4. Supply & Demand Zones Icon (Lightning / Zap / Energy zones)
export function ZonesIcon({ size = 18, className = "" }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
// 5. Trader Actionable Zones Icon (Crosshair / Target)
...
// 6. Volatility & Price Behavior Icon (Wave / Activity)
export function VolatilityIcon({ size = 18, className = "" }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
// 7. Session Behavior Icon (Clock / Timeframe)
...
// 8. Market Mood / Sentiment Icon (Compass / Gauge / Gauge dial)
export function SentimentIcon({ size = 18, className = "" }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
            <circle cx="12" cy="12" r="10" />
...
// 9. Candlestick Behavior Icon (Candlestick / OHLC bars)
export function CandlestickIcon({ size = 18, className = "" }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
            <rect x="5" y="7" width="4" height="10" rx="1" />
            <line x1="7" y1="3" x2="7" y2="7" />
            <line x1="7" y1="17" x2="7" y2="21" />
            <rect x="15" y="4" width="4" height="12" rx="1" />
...
// 10. Chart Patterns Icon (Geometric pattern / Triangle ruler)
export function PatternsIcon({ size = 18, className = "" }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
            <path d="M3 21h18V3L3 21z" />
...
// Brain / Deep Market Analysis Icon
export function BrainIcon({ size = 18, className = "" }) {
    return (
